...
* `velqimobile` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `velqimobile` - executable or bundle name on disk.
* `Velqi Music Windows` - display name shown in window titles and about app dialogs.
